...
C_SRCS += \
../drivers/nboot/src/fsl_nboot.c 

C_DEPS += \
./drivers/nboot/src/fsl_nboot.d 

OBJS += \
./drivers/nboot/src/fsl_nboot.o 


# Each subdirectory must supply rules for building sources it contributes
drivers/nboot/src/%.o: ../drivers/nboot/src/%.c drivers/nboot/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-drivers-2f-nboot-2f-src

clean-drivers-2f-nboot-2f-src:
	-$(RM) ./drivers/nboot/src/fsl_nboot.d ./drivers/nboot/src/fsl_nboot.o

.PHONY: clean-drivers-2f-nboot-2f-src
