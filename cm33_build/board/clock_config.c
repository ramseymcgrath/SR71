...
- {id: FLEXIO_clock.outFreq, value: 299.8125/2 MHz}
- {id: FLEXSPI_clock.outFreq, value: 299.8125/2 MHz}
- {id: FRO_12M_clock.outFreq, value: 12 MHz}
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
...
- {id: SYSCON.ENETRMIICLKDIV.scale, value: '3'}
- {id: SYSCON.ENETRMIICLKSEL.sel, value: SYSCON.pll1_clk0}
- {id: SYSCON.FCCLKSEL0.sel, value: SCG.FRO_12M}
- {id: SYSCON.FCCLKSEL4.sel, value: SCG.FRO_12M}
- {id: SYSCON.FLEXIOCLKSEL.sel, value: SYSCON.pll1_clk0}
- {id: SYSCON.FLEXSPICLKSEL.sel, value: SCG.PLL1_CLK}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.USB0CLKSEL.sel, value: SCG.CLK_48M}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_AttachClk(kCLK_48M_to_USB0);                 /*!< Switch USB0 to CLK_48M */
    ...
    CLOCK_AttachClk(kPLL1_CLK0_to_FLEXIO);                 /*!< Switch FLEXIO to PLL1_CLK0 */
    CLOCK_AttachClk(kPLL1_CLK0_to_ENETRMII);                 /*!< Switch ENETRMII to PLL1_CLK0 */

    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 1U);           /*!< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivUsb0Clk, 1U);           /*!< Set USB0CLKDIV divider to value 1 */
